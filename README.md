...
<br>when the binary is executed, the user will visualise the script mimicking sudo authentication process, the difference is that the password, when it's entered (and verified) succesfully, will get extracted and appended in a plain text file, e.g:
```
